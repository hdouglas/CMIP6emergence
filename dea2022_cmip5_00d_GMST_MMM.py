...
for thisRCP in scen_short:
    ...
    gmst_models = xr.DataArray(data=0.0, dims=['model','year'], coords=[validDirList,years], name='gmst') 
    ...
    for thisDir in validDirList:
        ...
        # Load the array
        gmstArrOrig = xr.open_dataarray('dea2022_allEns_gmst_'+thisRCP+'_allYears.nc')
    ...
    gmst_models.to_netcdf(path='MM_dea2022_gmst_'+thisRCP+'.nc')
