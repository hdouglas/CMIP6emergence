...
scen_short = ['ssp119','ssp126','ssp245','ssp370','ssp534-over','ssp585']
...
for thisSSP in scen_short:
    print(thisSSP)
    SN_models = xr.open_dataarray(SNpath+'MM_dea2022_SN_'+thisSSP+'_allYears.nc')
...
SN_SSP4D.to_netcdf(path=outPath+'dea2022_SN_SSP4D.nc')
...
pop_exposed.to_netcdf(path=outPath+'dea2022_pop_exposed_SN_SSP.nc')
pop_exposed_16.to_netcdf(path=outPath+'dea2022_pop_exposed_SN_SSP_16.nc')
pop_exposed_84.to_netcdf(path=outPath+'dea2022_pop_exposed_SN_SSP_84.nc')
...
# Save the output as netCDFs for future use. 
area_exposed.to_netcdf(path=outPath+'dea2022_area_exposed_SN_SSP.nc')
area_exposed_16.to_netcdf(path=outPath+'dea2022_area_exposed_SN_SSP_16.nc')
area_exposed_84.to_netcdf(path=outPath+'dea2022_area_exposed_SN_SSP_84.nc')
